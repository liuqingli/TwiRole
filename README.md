...
We publish a pre-trained version of TwiRole for role-related user classification on Twitter. The model can automatically crawl a user's profile, profile image and recent tweets, and classify a Twitter user into <span style="color:gray">📣**_Brand_**</span>, <span style="color: salmon">👚_**Female**_</span> or <span style="color: RoyalBlue">👔**_Male_**</span>, which is an aid to user-related research on Twitter.
